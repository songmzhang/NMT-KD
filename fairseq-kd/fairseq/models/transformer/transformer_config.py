...
class EncDecBaseConfig(FairseqDataclass):
    ...
    output_change_scale: ChoiceEnum(['default', 'O(n)', 'O(logn)', 'O(1)']) = field(
        default='default', metadata={"help": "the output change scale"}
    )
    as_parameter: bool = field(default=False, metadata={"help": "set omega as parameter"})
...
class TransformerConfig(FairseqDataclass):
    ...
    is_teacher: bool = field(
        default=False,
        metadata={"help": "whether this model is a teacher model."},
    )
